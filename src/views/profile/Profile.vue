<template>
  <div id="profile">
		<profile-nav class="profile-nav"><div slot="center">My center</div></profile-nav>
		<user-info @click.native="loginClick" />
...
<script>
	import ProfileNav from "Components/common/navbar/NavBar"
